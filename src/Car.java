...
public class Car extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Corrie se LandRover");

        jLabel3.setText("Rand Per Liter");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addComponent(rand, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if("".equals(this.rand.getText()) || "".equals(this.distance.getText()))
        {
            this.output.setText("Please inster details");
        }
        else
        {
            Calculations Cal = new Calculations(Float.parseFloat(this.rand.getText()));
            
            float fuel = Cal.calculateFuel(Float.parseFloat(this.distance.getText()));
            
            float cost = Cal.calculatePrice(fuel);
            
           String num = String.format("%.2f", cost);
            
            this.output.setText("Total Cost is : " + num);
        }
